...
-- Set custom keymaps (specific to split and my needs)
-- The plugin/nvim related ones are still in this file below
require 'keymaps'
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'cpp', 'diff', 'dockerfile', 'json', 'lua', 'luadoc', 'markdown', 'python', 'ssh_config', 'vim', 'vimdoc', 'yaml' },
